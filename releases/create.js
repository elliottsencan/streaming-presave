...
module.exports.create = (event, context, callback) => {
  event.Records.forEach(function(record) {
    ...
    const parsedReleaseDate = parseInt(
      record.dynamodb.NewImage.releaseDate.N,
      10
    );
    const releaseDate = moment(parsedReleaseDate).startOf("day").valueOf();
    ...
    const params = {
      TableName: process.env.RELEASES_TO_CAMPAIGNS_TABLE,
      Item: {
